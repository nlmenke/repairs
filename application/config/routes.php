...
| its corresponding controller class/method. The segments in a URL
| normally follow this pattern:
|
|   example.com/class/method/id/
|
| In some instances, however, you may want to remap this relationship so
| that a different class/function is called than the one corresponding to
| the URL. Please see the user guide for complete details:
|
