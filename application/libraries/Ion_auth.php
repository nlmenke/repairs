...
class Ion_auth {
     ...
     * __call
     *
     * Acts as a simple way to call model methods without loads of stupid
     * alias'
     *
     **/
     ...
     * __get
     *
     * Enables the use of CI super-global without having to define an
     * extra variable.
     *
     * I can't remember where I first saw this, so thank you if you are
     * the original author. -Militis
     *
     * @access    public
     *
     * @param    $var
    ...
    public function forgotten_password_complete($code) {
        ...
        if(!$profile) {
            $this->ion_auth_model->trigger_events(array(
...
/* Location: ./application/libraries/Ion_auth.php */