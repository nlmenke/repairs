...
| Edited:		04/01/2013
| Description:	Edited Pagination Class.
*/
...
class MY_Pagination {
	...
	var $cur_tag_open			= '<a class="button selected">';
	var $cur_tag_close			= '</a>';
	var $next_tag_open			= '';
	var $next_tag_close			= '';
	var $prev_tag_open			= '';
	...
	var $first_anchor_class		= 'first';
	var $prev_anchor_class		= 'previous';
	var $num_anchor_class		= '';
	var $next_anchor_class		= 'next';
	...
	public function __construct($params = array()) {
		...
		if($this->prev_anchor_class != '') {
			$this->prev_anchor_class = 'class="'.$this->prev_anchor_class.'" ';
		}
		
		if($this->num_anchor_class != '') {
			$this->num_anchor_class = 'class="'.$this->num_anchor_class.'" ';
		}
		
		if($this->next_anchor_class != '') {
			$this->next_anchor_class = 'class="'.$this->next_anchor_class.'" ';
		}
