 ...
 */
    (function(window, undefined) {
        ...
        // Instance methods
            ...
            ], pop = arr.pop, push_native = arr.push, push = arr.push, slice = arr.slice, // Use a stripped-down indexOf if we can't use a native one
            ...
            return markFunction(function(argument) {
                ...
                return markFunction(function(seed, matches) {
                    var j, matchIndexes = fn([
                        ], seed.length, argument), i = matchIndexes.length;
...
// Expose support vars for convenience
	...
	---------------------------------------------------------------------- */
            ...
            Expr.find["TAG"] = support.getElementsByTagName ? function(tag, context) {
                ...
                var elem, tmp = [
                    ], i = 0, results = context.getElementsByTagName(tag);
...
// Easy API for creating new setFilters
        ...
        function condense(unmatched, map, filter, context, xml) {
            var elem, newUnmatched = [
                ], i = 0, len = unmatched.length, mapped = map != null;
        ...
        function matcherFromGroupMatchers(elementMatchers, setMatchers) {
            ...
            var matcherCachedRuns = 0, bySet = setMatchers.length > 0, byElement = elementMatchers.length > 0, superMatcher = function(seed, context, xml, results, expandContext) {
                    var elem, j, matcher, setMatched = [
                        ...
                        ], outermost = expandContext != null, contextBackup = outermostContext, // We must always have either seed elements or context
    ...
    jQuery.event = {
        ...
        dispatch: function(event) {
            ...
            var i, ret, handleObj, matched, j, handlerQueue = [
                ], args = core_slice.call(arguments), handlers = ( jQuery._data(this, "events") || {} )[ event.type ] ||
                                                                 [
...
// Create "bubbling" focus and blur events
    ...
    jQuery.each({
        ...
        contents: function(elem) {
            return jQuery.nodeName(elem, "iframe") ? elem.contentDocument || elem.contentWindow.document : jQuery.merge(
                [], elem.childNodes);
        }
    }, function(name, fn) {
...
// Mark scripts as having already been evaluated
    ...
    jQuery.each({
        ...
        jQuery.fn[ name ] = function(selector) {
            var elems, i = 0, ret = [
                ], insert = jQuery(selector), last = insert.length - 1;
