...
(function($, undefined) {
    ...
    Datepicker.prototype = {
            ...
            this._secondaryEvents = [
                ...
                [
                    ...
                    'mousedown touchstart': $.proxy(function(e) {
                        ...
                        if(!(
                            this.element.is(e.target) || this.element.find(e.target).length || this.picker.is(e.target) || this.picker.find(e.target).length
                            )) {
                            this.hide();
                        }
                    }, this)
        ...
        update: function() {
            ...
            dates = $.grep(dates, $.proxy(function(date) {
                return (
                    date < this.o.startDate || date > this.o.endDate || !date
                    );
            }, this), true);
        ...
        getClassNames: function(date) {
            var cls = [
                ], year = this.viewDate.getUTCFullYear(), month = this.viewDate.getUTCMonth(), today = new Date();
    ...
    var DPGlobal = {
        ...
        getDaysInMonth: function(year, month) {
            return [
                31, (DPGlobal.isLeapYear(year) ? 29 : 28), 31, 30, 31,
