 ...
 */
    ...
    $.ui.plugin.add("resizable", "animate", {
        ...
        stop: function(event) {
            var that = $(this).data("ui-resizable"), o = that.options, pr = that._proportionallyResizeElements, ista = pr.length && (/textarea/i).test(pr[0].nodeName), soffseth = ista && $.ui.hasScroll(pr[0], "left") /* TODO - jump height */ ? 0 : that.sizeDiff.height, soffsetw = ista ? 0 : that.sizeDiff.width, style = { width: (that.size.width - soffsetw), height: (that.size.height - soffseth) }, left = (parseInt(that.element.css("left"), 10) + (that.position.left - that.originalPosition.left)) || null, top = (parseInt(that.element.css("top"), 10) + (that.position.top - that.originalPosition.top)) || null;
...
(function($, undefined) {
    ...
    $.widget("ui.sortable", $.ui.mouse, {
        ...
        _getItemsAsjQuery: function(connected) {
            ...
            var i, j, cur, inst, items = [], queries = [
            ...
            queries.push([
                $.isFunction(this.options.items) ? this.options.items.call(this.element, null, { options: this.options, item: this.currentItem }) : $(this.options.items, this.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"),
                this
            ]);
        ...
        // plusequals test for += 100 -= 100
            ...
            stringParsers = [
                ...
                },
                {
                    ...
                    parse: function(execResult) {
                        return [
                            execResult[ 1 ] * 2.55, execResult[ 2 ] * 2.55,
...
(function($, undefined) {
    ...
    $.effects.effect.size = function(o, done) {
        ...
        // Copy for children
            props2 = ["width", "height", "overflow"], cProps = [
                "fontSize"
            ], vProps = [
